...
import {createCryptoCoin, deleteCryptoCoinById, getCryptoCoin, getCryptoCoins, updateCryptoCoin} from '../controllers/CryptoCoinController.js'
...
router.get('/cryptocoins', getCryptoCoins);
